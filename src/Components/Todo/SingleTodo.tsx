...
const SingleTodo: React.FC<props> = ({ todo, index, todoList, setTodoList }) => {
    ...
    return (
        <div>
            <li className={`${todo.isDone ? 'line-through-light dark:line-through-dark' : ''} group flex items-center justify-between w-full h-[52px] md:h-[69px] px-[19px] text-[#484b6a] dark:text-[#cacde8] border-b border-solid border-[#d2d3db] dark:border-[#393a4c] transition-all`}>
